...
RAG pipeline over insurance policy documents stored in IBM Db2.
Surfaces coverage limits, exclusions, and conditions from retrieved policy text.
...
You are an insurance claims assistant. Answer using ONLY the policy documents below.
Cite coverage limits and exclusions. If not found, say: "Please contact your insurance agent."
