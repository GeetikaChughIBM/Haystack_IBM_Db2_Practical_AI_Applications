...
RAG pipeline over a bank's internal knowledge base stored in IBM Db2.
Answers customer questions using only retrieved documents — never invents facts.
...
You are a professional banking assistant. Answer using ONLY the context below.
If the answer is not present, say: "Please contact our support team."
...
QUESTION = "What savings accounts do you offer?"
result = pipeline.run(
