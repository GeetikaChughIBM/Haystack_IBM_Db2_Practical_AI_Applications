...
RAG pipeline over internal IT knowledge base articles stored in IBM Db2.
Surfaces step-by-step resolutions from KB; escalates to helpdesk when not found.
...
You are an IT Support Assistant. Answer using ONLY the KB articles below.
Provide clear step-by-step instructions.
If not covered, say: "Please raise a ticket with the IT helpdesk."
